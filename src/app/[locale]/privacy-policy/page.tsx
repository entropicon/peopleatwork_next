	...
	return (
		<>
			...
			>
				...
				>
					...
					<ListItem>
						<Typography variant="body1">
							...
							in this Agreement) refers to PeopleAtWork.
						</Typography>
					</ListItem>
					<ListItem>
						<Typography variant="body1">
					...
					<ListItem>
						<Typography variant="body1">
							<strong>Website</strong> refers to PeopleAtWork, accessible from{" "}
							<a
								href="https://peopleatwork.ai"
								rel="external nofollow noopener"
								target="_blank"
								style={{ color: "primary.main", textDecoration: "underline" }}
							>
								https://peopleatwork.ai
							</a>
						</Typography>
					</ListItem>
					<ListItem>
				...
				>
					<ListItem>By email: support@peopleatwork.ai</ListItem>
					<ListItem>
						By visiting this page on our website: peopleatwork.ai
					</ListItem>
				</List>
			</Box>
		</>
